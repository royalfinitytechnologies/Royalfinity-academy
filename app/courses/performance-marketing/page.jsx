    ...
    <>
      ...
      <section id="hero">
        ...
        <div className="hero-content">
          ...
          <div className="hero-stack-badges">
            <span className="stack-pill stack-php">Google Ads</span>
            <span className="stack-pill stack-laravel">Meta Ads</span>
            <span className="stack-pill stack-mysql">Analytics</span>
            <span className="stack-pill stack-html">Conversion Tracking</span>
            <span className="stack-pill stack-js">ROAS Optimization</span>
          </div>
          <h1 className="hero-title">
            Become a <em>Performance Marketing</em><br />Specialist
          </h1>
          <p className="hero-sub">
            Master the art of paid advertising — from Google Search to Meta Ads, conversion tracking to scaling
            campaigns profitably. Run real budgets on real campaigns, work in a real office, and land your
            marketing job with Royalfinity&apos;s premium mentorship.
          </p>
          ...
          <div className="hero-meta">
            <div className="hero-meta-item"><span className="dot"></span>3 Months Duration</div>
        ...
        <div className="overview-inner">
          <div className="overview-left reveal">
            ...
            <h2 className="section-title">
              Everything you need to<br /><em>run &amp; scale</em>
            </h2>
            <p className="section-desc">
              Performance Marketing is the fastest-growing skill in the digital world — every brand, agency, and
              startup is desperately hiring people who can run profitable paid campaigns. This course takes you from
              zero to managing real ad budgets on Google &amp; Meta, with a laser focus on ROI, ROAS, and results
              that businesses actually care about.
            </p>
            <div className="overview-highlights">
              <div className="highlight-row">
                ...
                <div className="highlight-text">
                  ...
                  <span>3 months | 5 days/week | Weekday batches available</span>
                </div>
              </div>
              <div className="highlight-row">
              ...
              <div className="highlight-row">
                ...
                <div className="highlight-text">
                  ...
                  <span>Basic computer &amp; internet knowledge — no prior ad experience needed</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="course-card-widget">
              ...
              <div className="course-card-body">
                <ul className="card-feature-list">
                  <li>Full 3-month structured curriculum</li>
                  ...
                  <li>10+ live campaign projects to run</li>
      ...
      <section id="curriculum">
        <div className="reveal">
          ...
          <h2 className="section-title">
            3 Months,<br /><em>Complete Performance Marketing Program</em>
          </h2>
          <p className="section-desc">
            A focused roadmap covering 2 months of strong theoretical foundation followed by 1 month of hands-on
            practical campaign execution and real-world experience.
          </p>
        </div>
        ...
        <div className="curriculum-grid">
          <div className="module-card reveal">
            ...
            <h3>Performance Marketing Foundations + Google Ads</h3>
            <ul className="module-topics">
              <li>Performance marketing overview &amp; key metrics</li>
              ...
              <li>Bidding strategies (Manual, tCPA, tROAS)</li>
            </ul>
          </div>
          ...
          <div className="module-card reveal reveal-delay-1">
            ...
            <h3>Meta Ads + Tracking &amp; Strategy</h3>
            <ul className="module-topics">
              <li>Facebook &amp; Instagram Ads Manager</li>
              <li>Campaign objectives &amp; funnel strategy</li>
              <li>Audience targeting &amp; lookalikes</li>
              <li>Meta Pixel &amp; Conversion API setup</li>
              <li>Creative strategy (video, carousel, static)</li>
              <li>A/B testing &amp; optimization techniques</li>
            </ul>
          </div>

          <div className="module-card reveal reveal-delay-2" style={{ border: '2px solid #C9A84C', position: 'relative' }}>
            ...
            <span className="module-phase">Month 3 · Practical</span>
            <h3>Live Campaigns + Analytics + Career Prep</h3>
            <ul className="module-topics">
              <li>Run real ad campaigns (Google + Meta)</li>
              <li>Campaign scaling &amp; budget management</li>
              <li>Google Analytics 4 &amp; reporting</li>
              <li>Landing page CRO &amp; performance tracking</li>
              <li>Client handling &amp; agency workflow</li>
              <li>Portfolio, mock interviews &amp; placement support</li>
            </ul>
          </div>
        </div>
        ...
        <div className="curriculum-cta-row reveal">
          ...
          <p className="curriculum-note">2 Months Theory + 1 Month Practical — focused on real campaign execution</p>
        </div>
      </section>
      ...
      <section id="tools">
        <div className="tools-header">
          ...
          <p className="section-desc reveal">
            When you join Royalfinity, you get access to the same tools professional performance marketers use
        ...
        <div className="tools-grid">
          <div className="tool-card reveal">
            ...
            <div className="tool-info">
              <strong>Google Ads Manager</strong>
              <span>Run &amp; manage real Search, Display &amp; Shopping campaigns</span>
            </div>
          </div>
          <div className="tool-card reveal reveal-delay-1">
            ...
            <div className="tool-info">
              ...
              <span>Full access to Facebook &amp; Instagram campaign tools</span>
            </div>
          </div>
          <div className="tool-card reveal reveal-delay-2">
            ...
            <div className="tool-info">
              ...
              <span>Design high-converting ad creatives &amp; banners</span>
            </div>
          </div>
          <div className="tool-card reveal">
            <div className="tool-emoji">📈</div>
            <div className="tool-info">
              ...
              <span>Build live dashboards &amp; client-ready ad reports</span>
            </div>
          </div>
          <div className="tool-card reveal reveal-delay-1">
            <div className="tool-emoji">🔥</div>
            <div className="tool-info">
              ...
              <span>Heatmaps &amp; session recordings for CRO analysis</span>
            </div>
          </div>
          <div className="tool-card reveal reveal-delay-2">
          ...
          <div className="tool-card reveal">
            ...
            <div className="tool-info">
              ...
              <span>Campaign planning &amp; client documentation</span>
            </div>
          </div>
          <div className="tool-card reveal reveal-delay-1">
            <div className="tool-emoji">🔍</div>
            <div className="tool-info">
              ...
              <span>Competitor ad research &amp; keyword intelligence</span>
            </div>
          </div>
        </div>
      ...
      <section id="cta-final">
        ...
        <div style={{ position: 'relative', zIndex: 2 }}>
          ...
          <h2 className="section-title reveal">
            Your career as a Performance Marketer<br />starts <em>right now</em>
          </h2>
          <p className="section-desc reveal">
            Join 400+ students who transformed their lives with Royalfinity&apos;s Performance Marketing program.
            New batch starting soon — seats fill fast.
          </p>
          <div className="cta-actions reveal">
            <Link href="#contact" className="btn-primary">Enroll Now — ₹9,999</Link>
