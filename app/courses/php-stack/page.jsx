...
//   title: 'PHP Full Stack Developer Course | Royalfinity',
//   description:
//     'Master PHP 8, Laravel, MySQL & REST APIs. 6-month job-ready program with real office environment, live projects & placement assistance. Enroll at ₹15,999.',
// };

export default function PhpStackPage() {
  useEffect(() => {
    ...
    <>
      ...
      <section id="hero">
        ...
        <div className="hero-content">
          ...
          <div className="hero-stack-badges">
            <span className="stack-pill stack-php">PHP 8</span>
            <span className="stack-pill stack-laravel">Laravel</span>
            <span className="stack-pill stack-mysql">MySQL</span>
            <span className="stack-pill stack-html">HTML/CSS</span>
            <span className="stack-pill stack-js">JavaScript</span>
          </div>
          <h1 className="hero-title">
            Become a <em>Full-Stack</em><br />PHP Developer
          </h1>
          <p className="hero-sub">
            Master the world&apos;s most widely used backend language — from core PHP to Laravel, MySQL to REST APIs.
            Build real-world projects, work in a real office, and land your dev job with Royalfinity&apos;s premium mentorship.
          </p>
        ...
        <div className="overview-inner">
          <div className="overview-left reveal">
            ...
            <p className="section-desc">
              PHP powers over 77% of the web — including WordPress, Facebook, and Wikipedia. This course takes you
              from zero to deploying production-grade Laravel applications, giving you the skills that thousands of
              companies are actively hiring for right now.
            </p>
            ...
            <div className="course-card-widget">
              ...
              <div className="course-card-body">
                <ul className="card-feature-list">
                  ...
                  <li>12+ real-world projects to build</li>
      ...
      <section id="curriculum">
        ...
        <div className="curriculum-grid">
          <div className="module-card reveal">
            ...
            <span className="module-phase">Month 1</span>
            <h3>Web Foundations + Basics</h3>
            <ul className="module-topics">
              <li>HTML5, CSS3, responsive design</li>
              <li>Bootstrap &amp; layout systems</li>
          ...
          <div className="module-card reveal reveal-delay-1">
            ...
            <span className="module-phase">Month 2</span>
            <h3>Core Programming &amp; Database</h3>
            <ul className="module-topics">
              <li>Programming fundamentals (logic building)</li>
              <li>Database basics (MySQL)</li>
          ...
          <div className="module-card reveal reveal-delay-2">
            ...
            <span className="module-phase">Month 3</span>
          ...
          <div className="module-card reveal">
            ...
            <span className="module-phase">Month 4</span>
            <h3>Industry Tools &amp; Advanced Topics</h3>
            <ul className="module-topics">
              <li>Version control (Git advanced)</li>
              <li>Working with APIs &amp; integrations</li>
        ...
        <div className="curriculum-cta-row reveal">
          ...
          <p className="curriculum-note">4 Months Theory + 2 Months Practical — designed for real job readiness</p>
        </div>
      </section>
      ...
      <section id="tools">
        <div className="tools-header">
          ...
          <p className="section-desc reveal">
            When you join Royalfinity, you get access to the same tools professional PHP/Laravel developers use
        ...
        <div className="tools-grid">
          <div className="tool-card reveal">
            ...
            <div className="tool-info">
              <strong>JetBrains PhpStorm</strong>
              <span>The #1 PHP IDE used by pros worldwide</span>
            </div>
          </div>
          <div className="tool-card reveal reveal-delay-1">
            ...
            <div className="tool-info">
              ...
              <span>Sleek GUI client for MySQL databases</span>
            </div>
          </div>
          ...
          <div className="tool-card reveal reveal-delay-2">
            <div className="tool-emoji">☁️</div>
            <div className="tool-info">
              <strong>Laravel Forge Credits</strong>
              <span>Deploy Laravel apps on any cloud server</span>
            </div>
          </div>
          <div className="tool-card reveal">
            <div className="tool-emoji">📝</div>
          ...
          <div className="tool-card reveal reveal-delay-1">
            ...
            <div className="tool-info">
              ...
              <span>Email testing sandbox for Laravel Mailables</span>
            </div>
          </div>
        </div>
      ...
      <section id="cta-final">
        ...
        <div style={{ position: 'relative', zIndex: 2 }}>
          ...
          <h2 className="section-title reveal">
            Your career as a PHP developer<br />starts <em>right now</em>
          </h2>
          <p className="section-desc reveal">
            Join 400+ students who transformed their lives with Royalfinity&apos;s PHP Full Stack program. New batch
